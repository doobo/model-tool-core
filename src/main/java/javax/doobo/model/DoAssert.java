...
import javax.doobo.utils.DoStringUtils;
 ...
 * Assert判断类
 */
public abstract class DoAssert {
    ...
    public static void hasLength( String text, String message) {
        if (!DoStringUtils.hasLength(text)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void doesNotContain( String textToSearch, String substring, String message) {
        if (DoStringUtils.hasLength(textToSearch) && DoStringUtils.hasLength(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    private static void instanceCheckFailed(Class<?> type,  Object obj,  String msg) {
        ...
        if (DoStringUtils.hasLength(msg)) {
